...
function rpc(request, callback) {
  ...
  var errorMessage = 'DIVI JSON-RPC: '
  ...
  var req = this.protocol.request(options, function(res) {
    ...
    res.on('end', function() {
      ...
      if (
        ...
        var exceededError = new Error('DIVI JSON-RPC: ' + buf.toString('utf8'))
...
RpcClient.callspec = {
  ...
  broadcastStartMasternode: 'str str',
  clearBanned: '',
  ...
  fundMasterNode: 'str float str str',
  fundVault: 'str float str',
  generate: 'int',
  generateBlock: 'str',
  getAccount: 'str',
  getAccountAddress: 'str',
  getAddedNodeInfo: 'bool str',
  getAddressBalance: 'str bool',
  getAddressesByAccount: 'str',
  getAddressDeltas: 'str bool',
  getAddressMempool: 'str',
  getAddressTxIds: 'str int int bool',
  getAddressUxtos: 'str bool',
  getBalance: 'str int',
  getBestBlockHash: '',
  getBlock: 'str bool',
  getBlockchainInfo: '',
  ...
  reclaimValutFunds: 'str float str',
  removeVault: 'str',
  reserveAddress: 'bool float',
  sendFrom: 'str str float int str str',
  sendMany: 'str str str',
  ...
  validateAddress: 'str',
  verifyChain: 'int',
  verifyMasternodeSetup: 'str str str str',
